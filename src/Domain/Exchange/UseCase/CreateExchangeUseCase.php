...
use FlexPHP\Bundle\QuoteBundle\Domain\Exchange\Response\CreateExchangeResponse;

final class CreateExchangeUseCase
{
    ...
    public function execute(CreateExchangeRequest $request): CreateExchangeResponse
    {
        return new CreateExchangeResponse($this->exchangeRepository->add($request));
    }
}
