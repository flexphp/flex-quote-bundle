...
use FlexPHP\Bundle\QuoteBundle\Domain\Exchange\Response\DeleteExchangeResponse;

final class DeleteExchangeUseCase
{
    ...
    public function execute(DeleteExchangeRequest $request): DeleteExchangeResponse
    {
        return new DeleteExchangeResponse($this->exchangeRepository->remove($request));
    }
}
